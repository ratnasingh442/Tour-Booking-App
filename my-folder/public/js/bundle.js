...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(type, data) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3000/app/v1/users/updatePassword' : 'http://localhost:3000/app/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  _regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51LAxNnSCoiKScyv3Mz1taXlgRtKYhhTQXhR601HarhTftUqS3nIzHB2IshtgAVrga2Yinq2Sr8f0FzFTmpkdtTTQ00nXH77VsT');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("http://localhost:3000/app/v1/booking/checkout-session/".concat(tourId));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return (0, _updateSettings.updateSetting)('data', form);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return (0, _updateSettings.updateSetting)('password', {
                password: password,
...
},{"./login":"login.js","./alert":"alert.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
